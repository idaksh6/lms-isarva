...
<aside class="lms-sidebar" :class="{ 'is-open': sidebarOpen }" @keydown.escape.window="sidebarOpen = false">
    <div class="lms-sidebar-inner">
        <div class="flex items-center justify-between lg:hidden">
            <span class="text-xs font-bold text-isarva-heading">Menu</span>
            <button type="button" @click="sidebarOpen = false" class="rounded-lg p-1.5 text-slate-500 hover:bg-slate-100" aria-label="Close">
